...
╭════ • ›「 GRUPO 」
├≽️ * .Intro *
├ _Lista de introdução newmem_
├≽️ * .Setname *
├ _Alterar o nome do grupo_
├≽️ * .Setdesc *
├ _Alterar descrição do grupo_
├≽️ * .Opengc *
├ _Abrir grupo_
├≽️ * .Closegc *
├ _Fechar grupo_
├≽️ *! Notif (texto) *
├ _Dê notificações aos membros_
╰═══════════════

╭════ • ›「 Jogo 」
├≽️ * .Picture *
├ _Aleatória adivinha a imagem_
├≽️ * .Family100 *
├ _Família de Perguntas Aleatórias 100_
├≽️ * .Tod (texto) *
├ _.Truth_
├ _.Dare_
├≽️ * Conchas mágicas *
...
├ _ Pantun aleatório_
├≽️ *. Pequeno *
├ _Receber piadas aleatórias_
├≽️ * .Statpack *
├ _Piadas aleatórias bapack_
├≽️ * .Gombal *
├ _Palavra aleatória merda_
├≽️ * .Diga *
├ _Ex =. Diga que te amo_
├≽️ * .Infonime (nome do anime) *
├ _.Infonime naruto_
├≽️ * .Namae *
├ _Ex = .Namae udin_
├≽️ * .Alay *
...
├ _Poesia aleatória_
├≽️ *. Curto *
├ _ Histórias curtas aleatórias_
├≽️ * .Tagme *
├ _Auto tag_
├≽️ *. Alguns dias *
├ _Percentagem de gays_
├≽️ *. Algumas almofadas *
├ _Percentagem de bucin_
├≽️ * .Ping *
├ _Conhecendo a velocidade de resposta_
├≽️ * .Chatprank (texto1 / texto2) *
├ _Ex: .Chatprank Olá, senhor / sat_
├≽️ * .Alay (texto) *
├ _Ex: Toca oi udin_
╰═══════════════

╭════ • ›「 PRIMBON 」
├≽️ *. Significa (seu nome) *
├ _Ex =. Média udin_
├≽️ * .Couple (seu nome e doi) *
├ _Ex =. Casal udin & udan_
├≽️ * .Getzodiac *
├ _Ex: .Getzodiak udin & 09-09-2002_
├≽️ * .Zodíaco (zodíaco) *
├ _Ex: .Zodiac libra_
├≽️ *. Sonho (texto) *
├ _Ex: Sonho de uma cobra.
╰═══════════════

╭════ • ›「 FERRAMENTAS 」
├≽️ * .Stickers *
├ _Enviar tipo de foto .stiker_
├≽️ *. Escreva *
├ _Ex =. Escreva I love udin_
├≽️ * .Ocr *
├ _Copie frases na imagem_
├≽️ * .Stalk (nome de usuário ig) *
├ _Ex = .Stalk @udin_
├≽️ * .Shortlink (link) *
├ _Link mais curto_
╰═══════════════
...
╭════ • ›「 IMAGEM 」
├≽️ * .Cecan / .Cogan *
├ _Foto aleatória de menina / menino_
├≽️ * .Anime *
├ _Foto anime aleatório_
├≽️ * .Loli *
├ _Foto de anime loli aleatório_
├≽️ * .Neko *
├ _ Foto aleatória de neko anime_
├≽️ * .Quotes *
├ _Citações de fotos aleatórias_
├≽️ * .Twit *
├ _Twit aleatório_
├≽️ * .Wp *
├ _Papel de parede aleatório_
├≽️ * .Img (nome procurado) *
├ _Ex = .Img iqbal_
├≽️ * .Meme *
├ _Foto bonito aleatório_
╰═══════════════

╭════ • ›「 TEXTO 」
├≽️ * .Kata (citações / autor) *
├ _Ex =. Disse que o amo / Udin_
├≽️ * .Logopornhub (texto1 / texto2) *
├ _Ex: .Logopornhub Udin / nime
├≽️ * .Lion (texto1 / texto2) *
├ _Ex: .Lion Udin / nime
├≽️ * .Ninja (texto1 / texto2) *
├ _Ex: Ninja Udin / nime
├≽️ *. Joker (texto1 / texto2) *
├ _Ex: Joker Udin / nime
├≽️ * .Glitch (texto1 / texto2) *
├ _Ex: .Glich Udin / nime
├≽️ * .Neve (texto) *
├ _Ex: .Snow Udin
├≽️ * .Neon (texto) *
...
├≽️ * .Água (texto) *
├ _Ex: .Water Udin_
├≽️ * .Wolf (texto1 / texto2) *
├ _Ex: .Wolf Udin / nime_
╰═══════════════

╭════ • ›「 EDUCAÇÃO 」
├≽️ * .Brainly (pergunta) *
├ _Taking Brainly answer_
├≽️ *. Alcorão *
├ _Verso aleatório do Al-Quran_
├≽️ *. Alquran (número do verso)
├ _Ex: Alcorão 1_
├≽️ * .Wiki *
├ _Ex =. Wiki de história da Indonésia_
├≽️ * .Covid *
├ _A última informação sobre covid indo_
├≽️ * .Fact *
├ _Fatos aleatórios_
├≽️ * .Kbbi (palavra) *
├ _Ex = .Kbbi man_
├≽️ *. Data (data procurada) *
├ _Info sobre datas nacionais_
╰═══════════════

╭════ • ›「 TEMPO 」
├≽️ * .Bmkg *
├ _Informações aleatórias de BMKG_
├≽️ * .Earthquake *
├ _Informações sobre terremotos aleatórios_
├≽️ * .Weather (nome da região) *
├ _Ex =. Clima Jacarta_
╰═══════════════

╭════ • ›「 OUTROS 」
├≽️ * .Sholat (nome da área) *
├ _Ex =. Oração de Jacarta_
├≽️ * .Tv Schedule (nome do canal) *
├ _Ex = .Rcti_TV Agenda
├≽️ *. Letras *
├ _Ex =. Letras Anji - Dia_
├≽️ * .Chord *
├ _Ex = .Chord Anji - Dia_
├≽️ * .Map (nome da área) *
├ _Mini map_
